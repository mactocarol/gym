                                                            ...
                                                            <select name="customer_id" id="customer_id" class="form-control select2" required>
                                                                ...
                                                                <optgroup label="Client Name">
                                                                    <?php foreach($customers as $row) { ?>
                                                                        <option value="<?=$row['id']?>" <?php echo ($subscription && ($subscription->customer_id == $row['id']) ) ? 'selected' : ''; ?>><?=$row['f_name'].' '.$row['l_name']?></option>
                                                                    <?php } ?>                                                                    
                                                                </optgroup>
                                                            </select>
                                                            ...
                                                            <select id="membership_id" name="membership_id" class="form-control select2" onclick="getPrice(this.value);">
                                                                ...
                                                                <optgroup label="Membership Plans">
                                                                    <?php foreach($memberships as $row) { ?>
                                                                        <option value="<?=$row['id']?>" <?php echo ($subscription && ($subscription->membership_id == $row['id']) ) ? 'selected' : ''; ?>><?=$row['name']?></option>
                                                                    <?php } ?>                                                                    
                                                                </optgroup>
                                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group selectcost">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" id="cost" name="cost" class="form-control" placeholder="Membership Cost" value="<?php echo ($membership) ? $membership->price : ''; ?>" onkeyup="calculateDiscount(this.value);">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group selectamount">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" id="amount" name="amount" class="form-control" placeholder="Amount To Be Paid" value="<?php echo ($subscription) ? $subscription->amount : ''; ?>" onkeyup="calculateDiscount(this.value);">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" id="discount" name="discount" class="form-control" placeholder="Discount" value="<?php echo ($subscription) ? $subscription->discount : ''; ?>" onkeyup="calculateAmount(this.value);">                                                            
                                                        </div>                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group selectregisterdate">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="register_date" name="register_date" class="form-control mydatepicker" placeholder="dd-mm-yyyy" value="<?php echo ($subscription) ? $subscription->register_date : ''; ?>" autocomplete="off" readonly>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group selectstartdate">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="start_date" name="start_date" class="form-control mydatepicker" placeholder="dd-mm-yyyy" value="<?php echo ($subscription) ? $subscription->start_date : ''; ?>" autocomplete="off" readonly>
                                                                <span class="input-group-addon"><i class="icon-calender"></i></span>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" name="remarks" class="form-control" placeholder="remarks, if any" value="<?php echo ($subscription) ? $subscription->remarks : ''; ?>">
                                                        </div>
                                                    </div>
                                                </div>                                               
                                            </div>                                                                                                                                  
